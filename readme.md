...
Here are possible initial contributions, you can also look through the open [issues](https://github.com/RDjarbeng/countdown/issues) for ideas. Or you can implement features that you think should be included. We would love to see what you add🌟.
