...
import { setDateAttributes, closeFormPopUp } from "./form.js";
// let setDateAttributes= ()=>{console.log('I am the cause')}
...
function popForm() {
    ...
    setDateAttributes();
    // document.querySelector(".close-form").onclick = (e) => { closeFormPopUp(); }
...
//     console.log('form in form update');
